...
contract CrowdFunder {
    ...
    // certain functions only creators can execute
    modifier isCreator() {
    ...
    public
    {
        if (totalRaised > minimumToRaise) {
            ...
            state = State.ExpiredRefund; // backers cannow collect refunds by calling getRefund(id)
        }
        completeAt = now;
    }
    ...
    function getRefund(uint 256 id)
